...
namespace StylizedWaterShader
{
    public class StylizedWaterRenderer : Object
    {
        ...
        private Camera SetupRenderCam()
        {
            ...
            //Add margin, in case mesh is completly flat
            ...
            camPosY = targetCenterPosition.y - CLIP_PLANE_PADDING;
            camPosZ = targetCenterPosition.z;

            //Position cam in given center of mesh
            renderCam.transform.position = new Vector3(camPosX, camPosY, camPosZ);
